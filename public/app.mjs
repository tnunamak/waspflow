var ne, k, Fe, H, ve, Ue, He, ae, B, M, Ee, pe, le, ce, V = {}, K = [], et = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, re = Array.isArray;
function F(t, e) {
...
function nt(t) {
  if (t.__P && t.__d) {
    ...
    i.__v = e.__v + 1, k.vnode && k.vnode(i), he(t.__P, i, e, t.__n, t.__P.namespaceURI, 32 & e.__u ? [r] : null, a, r ?? L(e), !!(32 & e.__u), s), i.__v = e.__v, i.__.__k[i.__i] = i, Oe(a, i, s), e.__e = e.__ = null, i.__e != r && De(i);
  }
}
function De(t) {
...
function be(t) {
  (!t.__d && (t.__d = !0) && H.push(t) && !Q.__r++ || ve != k.debounceRendering) && ((ve = k.debounceRendering) || Ue)(Q);
}
function Q() {
  try {
...
function Le(t, e, r, a, s, i, d, c, p, l, h) {
  var f, o, u, g, _, y, w, b = a && a.__k || K, m = e.length;
  for (p = rt(r, e, b, p, m), f = 0; f < m; f++) (u = r.__k[f]) != null && (o = u.__i != -1 && b[u.__i] || V, u.__i = f, y = he(t, u, o, s, i, d, c, p, l, h), g = u.__e, u.ref && o.ref != u.ref && (o.ref && me(o.ref, null, u), h.push(u.ref, u.__c || g, u)), _ == null && g != null && (_ = g), (w = !!(4 & u.__u)) || o.__k === u.__k ? (p = We(u, p, t, w), w && o.__e && (o.__e = null)) : typeof u.type == "function" && y !== void 0 ? p = y : g && (p = g.nextSibling), u.__u &= -7);
  return r.__e = _, p;
}
...
function it(t, e, r, a) {
  var s, i, d, c = t.key, p = t.type, l = e[r], h = l != null && (2 & l.__u) == 0;
  if (l === null && c == null || h && c == l.key && p == l.type) return r;
  if (a > (h ? 1 : 0)) {
    for (s = r - 1, i = r + 1; s >= 0 || i < e.length; ) if ((l = e[d = s >= 0 ? s-- : i++]) != null && (2 & l.__u) == 0 && c == l.key && p == l.type) return d;
  }
  return -1;
}
function ye(t, e, r) {
...
function j(t, e, r, a, s) {
  ...
  else if (e[0] == "o" && e[1] == "n") i = e != (e = e.replace(Ee, "$1")), d = e.toLowerCase(), e = d in t || e == "onFocusOut" || e == "onFocusIn" ? d.slice(2) : e.slice(2), t.l || (t.l = {}), t.l[e + i] = r, r ? a ? r[M] = a[M] : (r[M] = pe, t.addEventListener(e, i ? ce : le, i)) : t.removeEventListener(e, i ? ce : le, i);
  else {
  ...
  e: if (typeof $ == "function") {
    ...
    try {
      if (b = e.props, m = $.prototype && $.prototype.render, v = (h = $.contextType) && a[h.__c], x = h ? v ? v.props.value : h.__ : a, r.__c ? w = (o = e.__c = r.__c).__ = o.__E : (m ? e.__c = o = new $(b, x) : (e.__c = o = new J(b, x), o.constructor = $, o.render = ot), v && v.sub(o), o.state || (o.state = {}), o.__n = a, u = o.__d = !0, o.__h = [], o._sb = []), m && o.__s == null && (o.__s = o.state), m && $.getDerivedStateFromProps != null && (o.__s == o.state && (o.__s = F({}, o.__s)), F(o.__s, $.getDerivedStateFromProps(b, o.__s))), g = o.props, _ = o.state, o.__v = e, u) m && $.getDerivedStateFromProps == null && o.componentWillMount != null && o.componentWillMount(), m && o.componentDidMount != null && o.__h.push(o.componentDidMount);
        ...
        o.componentWillUpdate != null && o.componentWillUpdate(b, o.__s, x), m && o.componentDidUpdate != null && o.__h.push(function() {
          o.componentDidUpdate(g, _, y);
        });
      }
      if (o.context = x, o.props = b, o.__P = t, o.__e = !1, q = k.__r, R = 0, m) o.state = o.__s, o.__d = !1, q && q(e), h = o.render(o.props, o.state, o.context), K.push.apply(o.__h, o._sb), o._sb = [];
      else do
...
function je(t) {
  return typeof t != "object" || t == null || t.__b > 0 ? t : re(t) ? t.map(je) : t.constructor !== void 0 ? null : F({}, t);
}
function at(t, e, r, a, s, i, d, c, p) {
  var l, h, f, o, u, g, _, y = r.props || V, w = e.props, b = e.type;
  if (b == "svg" ? s = "http://www.w3.org/2000/svg" : b == "math" ? s = "http://www.w3.org/1998/Math/MathML" : s || (s = "http://www.w3.org/1999/xhtml"), i != null) {
    for (l = 0; l < i.length; l++) if ((u = i[l]) && "setAttribute" in u == !!b && (b ? u.localName == b : u.nodeType == 3)) {
      t = u, i[l] = null;
      break;
    }
  }
  if (t == null) {
    ...
    t = document.createElementNS(s, b, w.is && w), c && (k.__m && k.__m(e, i), c = !1), i = null;
  }
  if (b == null) y === w || c && t.data == w || (t.data = w);
  else {
    if (i = b == "textarea" && w.defaultValue != null ? null : i && ne.call(t.childNodes), !c && i != null) for (y = {}, l = 0; l < t.attributes.length; l++) y[(u = t.attributes[l]).name] = u.value;
    for (l in y) u = y[l], l == "dangerouslySetInnerHTML" ? f = u : l == "children" || l in w || l == "value" && "defaultValue" in w || l == "checked" && "defaultChecked" in w || j(t, l, null, u, s);
    for (l in w) u = w[l], l == "children" ? o = u : l == "dangerouslySetInnerHTML" ? h = u : l == "value" ? g = u : l == "checked" ? _ = u : c && typeof u != "function" || y[l] === u || j(t, l, u, y[l], s);
    if (h) c || f && (h.__html == f.__html || h.__html == t.innerHTML) || (t.innerHTML = h.__html), e.__k = [];
    else if (f && (t.innerHTML = ""), Le(e.type == "template" ? t.content : t, re(o) ? o : [o], e, r, a, b == "foreignObject" ? "http://www.w3.org/1999/xhtml" : s, i, d, i ? i[0] : r.__k && L(r, 0), c, p), i != null) for (l = i.length; l--; ) _e(i[l]);
    c && b != "textarea" || (l = "value", b == "progress" && g == null ? t.removeAttribute("value") : g != null && (g !== t[l] || b == "progress" && !g || b == "option" && g != y[l]) && j(t, l, g, y[l], s), l = "checked", _ != null && _ != t[l] && j(t, l, _, y[l], s));
  }
  return t;
}
function me(t, e, r) {
...
function ze(t, e, r) {
  var a, s;
  if (k.unmount && k.unmount(t), (a = t.ref) && (a.current && a.current != t.__e || me(a, null, e)), (a = t.__c) != null) {
...
function st(t, e, r) {
  var a, s, i, d;
  e == document && (e = document.documentElement), k.__ && k.__(t, e), s = (a = !1) ? null : e.__k, i = [], d = [], he(e, t = e.__k = tt(T, null, [t]), s || V, V, e.namespaceURI, s ? null : e.firstChild ? ne.call(e.childNodes) : null, i, s ? s.__e : e.firstChild, a, d), Oe(i, t, d), t.props.children = null;
}
ne = K.slice, k = { __e: function(t, e, r, a) {
...
function n(t, e, r, a, s, i) {
  e || (e = {});
  var d, c, p = e;
  if ("ref" in p) for (c in p = {}, e) c == "ref" ? d = e[c] : p[c] = e[c];
  var l = { type: t, props: p, key: r, ref: d, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --lt, __i: -1, __u: 0, __source: s, __self: i };
  if (typeof t == "function" && (d = t.defaultProps)) for (c in d) p[c] === void 0 && (p[c] = d[c]);
  return k.vnode && k.vnode(l), l;
}
var O, N, oe, we, X = 0, Be = [], S = k, xe = S.__b, Ne = S.__r, Se = S.diffed, Ce = S.__c, qe = S.unmount, Te = S.__;
function fe(t, e) {
...
function ct(t, e, r) {
  ...
  if (a.t = t, !a.__c && (a.__ = [Je(void 0, e), function(c) {
    ...
    var s = function(c, p, l) {
      if (!a.__c.__H) return !0;
      var h = !1, f = a.__c.props !== c;
    ...
    N.componentWillUpdate = function(c, p, l) {
      if (this.__e) {
        var h = i;
        i = void 0, s(c, p, l), i = h;
      }
      d && d.call(this, c, p, l);
...
function ut() {
  for (var t; t = Be.shift(); ) {
    var e = t.__H;
    if (t.__P && e) try {
      e.__h.some(Y), e.__h.some(de), e.__h = [];
    } catch (r) {
      e.__h = [], S.__e(r, t.__v);
    }
  }
...
S.__b = function(t) {
  ...
  })) : (e.__h.some(Y), e.__h.some(de), e.__h = [], O = 0)), oe = N;
}, S.diffed = function(t) {
  Se && Se(t);
  var e = t.__c;
  ...
  e.some(function(r) {
    try {
      r.__h.some(Y), r.__h = r.__h.filter(function(a) {
        return !a.__ || de(a);
      });
    } catch (a) {
      e.some(function(s) {
...
function Qe({ view: t, status: e, control: r }) {
  ...
  if (t.name === "join") return /* @__PURE__ */ n(E, { children: /* @__PURE__ */ n(C, { title: "Join your collective", lead: "Paste the invite your operator sent you.", children: [
    ...
    /* @__PURE__ */ n("textarea", { id: "invite", value: a, onInput: (c) => s(c.currentTarget.value), placeholder: "Paste your invite link" }),
  ...
  if (t.name === "setup") return /* @__PURE__ */ n(E, { children: /* @__PURE__ */ n(C, { title: "Your sandbox needs attention", lead: "Complete this once, then come back to contribute.", children: [
    /* @__PURE__ */ n("ol", { children: (t.checks.length ? t.checks : [{ detail: "Open Federation again after Docker Sandbox setup is complete." }]).map((c) => /* @__PURE__ */ n("li", { children: [
      c.detail || c.name,
      " ",
      c.fix || ""
    ] })) }),
...
function Nt({ status: t, settings: e, tasks: r, identity: a, coordinatorUnavailable: s, control: i, goTask: d, beginGitHub: c }) {
  const p = ue(t), [l, h] = P(null), [f, o] = P(!1);
  if (p.name !== "status") return /* @__PURE__ */ n(Qe, { view: p, status: t, control: i });
  const u = p.control === "pause", g = t?.contribution || {}, _ = l || r[0];
  return /* @__PURE__ */ n("div", { className: "view-stack", children: [
    /* @__PURE__ */ n(C, { title: "Your contribution", children: [
      /* @__PURE__ */ n("div", { className: "contribution-state", children: [
        ...
        /* @__PURE__ */ n("div", { children: [
          ...
          /* @__PURE__ */ n("p", { className: "detail", children: u && g.display_id ? `Working on “${g.display_id}”${g.requester || g.author ? ` for ${g.requester || g.author}` : ""}` : t?.detail || "Nothing will run until you approve a task." })
        ] })
      ] }),
      ...
      /* @__PURE__ */ n(W, { status: "problem", children: s ? "Your collective is unreachable right now. Nothing changed on this computer." : null }),
      /* @__PURE__ */ n("div", { className: "actions", children: [
        ...
        u && g.task_digest ? /* @__PURE__ */ n("button", { type: "button", className: "secondary", onClick: () => d(g.task_digest), children: "Watch what it’s doing →" }) : null
      ] }),
    ...
    !u && !s && (_ ? /* @__PURE__ */ n(C, { title: l ? "Review this task" : "Tasks ready for review", lead: l ? "Read the full request before deciding whether to use your account." : "Nothing runs without your say.", className: l ? "consent-card" : "", children: l ? /* @__PURE__ */ n(T, { children: [
      /* @__PURE__ */ n("p", { children: [
        /* @__PURE__ */ n("strong", { children: _.display_id || "Untitled task" }),
        " from ",
        _.author || "Unknown requester"
      ] }),
      /* @__PURE__ */ n("p", { className: "full-prompt", children: _.prompt || _.prompt_preview || "Prompt was not included." }),
      /* @__PURE__ */ n("p", { children: [
        "Will use: ",
        Ye(a),
        " · isolated sandbox",
        _.network === "enabled" || _.git_source ? " · internet access" : ""
      ] }),
      /* @__PURE__ */ n("p", { children: "Estimated: a few minutes, based on similar tasks." }),
      /* @__PURE__ */ n(Xe, { task: _ }),
      /* @__PURE__ */ n("div", { className: "actions", children: [
        _.git_source?.authentication_required && !D(a?.providers).some((y) => y.service === "github" && y.authed) ? /* @__PURE__ */ n("button", { type: "button", onClick: c, children: "Set up GitHub access" }) : /* @__PURE__ */ n("button", { type: "button", onClick: () => i("/contribute/start", { task_digest: _.task_digest }), children: "Accept and run" }),
        /* @__PURE__ */ n("button", { type: "button", className: "secondary", onClick: () => h(null), children: "Skip this one" })
      ] })
    ] }) : /* @__PURE__ */ n(T, { children: [
      /* @__PURE__ */ n("button", { type: "button", className: "secondary", onClick: () => h(_), children: "Review the next task" }),
      /* @__PURE__ */ n(St, { tasks: r, onSelect: h })
...
function Rt({ requests: t, submission: e, form: r, setForm: a, submit: s, probeGit: i, acknowledge: d }) {
  return /* @__PURE__ */ n("div", { className: "view-stack", children: [
    ...
    /* @__PURE__ */ n(C, { title: "Requests", lead: "Submitted tasks and their live progress.", children: [
      ...
      t.length ? /* @__PURE__ */ n("ul", { className: "request-list", children: t.map((c) => /* @__PURE__ */ n("li", { children: /* @__PURE__ */ n("a", { className: "request-select", href: `#/tasks/${encodeURIComponent(c.task_digest)}`, children: [
        /* @__PURE__ */ n("span", { children: [
          /* @__PURE__ */ n("strong", { children: c.display_id || "Untitled task" }),
          /* @__PURE__ */ n("small", { children: c.published_at ? ge(c.published_at) : "Recently submitted" })
        ] }),
        /* @__PURE__ */ n(te, { value: c.status })
      ] }) })) }) : /* @__PURE__ */ n("div", { className: "empty-state", children: [
...
function At({ form: t, setForm: e, submit: r, probeGit: a }) {
  ...
  return /* @__PURE__ */ n("div", { className: "view-stack", children: [
    /* @__PURE__ */ n("a", { className: "back-link", href: "#/requests", children: "← Requests" }),
    /* @__PURE__ */ n(C, { title: "New request", lead: "Describe the outcome for your collective.", children: /* @__PURE__ */ n("form", { onSubmit: (c) => {
      ...
      t.files.length > 0 && /* @__PURE__ */ n("ul", { className: "file-list", children: t.files.map((c, p) => /* @__PURE__ */ n("li", { children: [
        c.webkitRelativePath || c.name,
        " · ",
        c.size,
        " bytes ",
        /* @__PURE__ */ n("button", { type: "button", className: "secondary", onClick: () => e((l) => ({ ...l, files: l.files.filter((h, f) => f !== p) })), children: "Remove" })
      ] })) }),
      /* @__PURE__ */ n("details", { children: [
...
function Ft({ section: t, identity: e, settings: r, roster: a, save: s, signIn: i, status: d, join: c, message: p }) {
  const [l, h] = P(r?.schedule || { enabled: !1, start: "", end: "", days: "", timezone: Intl.DateTimeFormat().resolvedOptions().timeZone }), [f, o] = P(""), u = ["contributing", "pausing", "action_needed"].includes(d?.state) || ["pending", "published"].includes(d?.submission?.state);
  if (Z(() => {
    r?.schedule && h(r.schedule);
  }, [r]), t === "collective") return /* @__PURE__ */ n("div", { className: "view-stack", children: /* @__PURE__ */ n(C, { title: "Collective", lead: "This machine is set to use this collective.", children: [
    /* @__PURE__ */ n("p", { children: r?.collective_name || e?.collective_name || "Collective name not captured yet." }),
    /* @__PURE__ */ n("h3", { children: "Members" }),
    /* @__PURE__ */ n("ul", { className: "roster", children: a.map((_) => /* @__PURE__ */ n("li", { children: [
      /* @__PURE__ */ n("strong", { children: _.display_name || _.name || _.key_id }),
      /* @__PURE__ */ n("span", { className: "role-chip", children: _.role || "Member" }),
      /* @__PURE__ */ n("small", { children: _.joined_at ? `Joined ${ge(_.joined_at)}` : "Join date not captured" })
    ] })) }),
    /* @__PURE__ */ n("details", { children: [
    ...
    /* @__PURE__ */ n("h3", { children: "Join a different collective" }),
    /* @__PURE__ */ n("label", { htmlFor: "switch-invite", children: [
      "Invite",
      /* @__PURE__ */ n("textarea", { id: "switch-invite", value: f, onInput: (_) => o(_.currentTarget.value), placeholder: "Paste an invite link" })
    ] }),
    u && /* @__PURE__ */ n("p", { className: "muted", children: "Finish the current work before switching collectives." }),
    /* @__PURE__ */ n("button", { type: "button", disabled: u, onClick: () => c(f), children: "Join different collective" }),
    /* @__PURE__ */ n(W, { children: p })
  ] }) });
  const g = D(e?.accounts || e?.providers);
  return /* @__PURE__ */ n("div", { className: "view-stack", children: /* @__PURE__ */ n(C, { title: "Device & accounts", lead: "Settings for this computer only.", children: [
    ...
    /* @__PURE__ */ n("label", { children: [
      /* @__PURE__ */ n("input", { type: "checkbox", checked: l.enabled, onChange: (_) => h({ ...l, enabled: _.currentTarget.checked }) }),
      " Contribute on a schedule"
    ] }),
    /* @__PURE__ */ n("div", { className: "day-chips", children: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((_) => /* @__PURE__ */ n("button", { type: "button", className: String(l.days || "").split(",").includes(_) ? "selected" : "", onClick: () => {
      const y = new Set(String(l.days || "").split(",").filter(Boolean));
      y.has(_) ? y.delete(_) : y.add(_), h({ ...l, days: [...y].join(",") });
    }, children: _ })) }),
    /* @__PURE__ */ n("label", { children: [
      "Start",
      /* @__PURE__ */ n("input", { value: l.start || "", onInput: (_) => h({ ...l, start: _.currentTarget.value }) })
    ] }),
    /* @__PURE__ */ n("label", { children: [
      "End",
      /* @__PURE__ */ n("input", { value: l.end || "", onInput: (_) => h({ ...l, end: _.currentTarget.value }) })
    ] }),
    ...
    g.map((_) => /* @__PURE__ */ n("div", { className: "provider-card", children: [
      /* @__PURE__ */ n("strong", { children: ee(_.service || _.provider) }),
      /* @__PURE__ */ n("p", { children: _.authed ? "Ready to use" : "Not detected yet — checking your sign-in…" }),
      !_.authed && /* @__PURE__ */ n("button", { type: "button", className: "secondary", onClick: () => i(_.service || _.provider), children: [
        "Sign in to ",
        ee(_.service || _.provider)
      ] })
    ] })),
    ...
    d?.detail?.match(/sign-in could not start/i) && /* @__PURE__ */ n(W, { status: "attention", children: [
...
function Ht() {
  const t = new URLSearchParams(location.search).get("token") || "", [e, r] = P({ status: null, tasks: [], requests: [], ledger: [], identity: null, settings: null, roster: [], coordinatorUnavailable: !1, sessionExpired: !1, daemonUnavailable: !1, message: "", submission: null }), [a, s] = P(Re), [i, d] = P(() => Pe(location.hash)), [c, p] = P(null), [l, h] = P(null), f = z(async (m, v = {}) => {
    const x = await fetch(m, { ...v, headers: { "x-waspflow-session-token": t, ...v.body ? { "content-type": "application/json" } : {} } });
    let q = {};
    try {
      q = await x.json();
    } catch {
  ...
  Z(() => {
    ...
    o();
    const v = setInterval(o, bt);
    return () => {
      removeEventListener("hashchange", m), clearInterval(v);
    };
  }, [o, e.sessionExpired]);
  const u = async (m, v) => {
    try {
      const x = await f(m, { method: "POST", body: v ? JSON.stringify(v) : void 0 });
  ...
  }, [f]), w = i.name === "tasks" ? decodeURIComponent(i.parts[0] || "") : "";
  if (Z(() => {
    w && _(w);
  }, [w, _]), e.sessionExpired) return /* @__PURE__ */ n(E, { children: /* @__PURE__ */ n(C, { title: "This local link has expired", lead: _t, children: /* @__PURE__ */ n("button", { type: "button", onClick: () => {
  ...
  if (i.name === "tasks") return /* @__PURE__ */ n(T, { children: [
    ...
    /* @__PURE__ */ n("main", { id: "main-content", children: /* @__PURE__ */ n(Ct, { digest: w, task: c, log: l, loadLog: y, resultHref: w ? `/result/${encodeURIComponent(w)}?token=${encodeURIComponent(t)}` : null }) })
  ] });
