# Task 20260722-190800-complete-federation-linux-package-self-service-f H03 Plan

## Goal
add curl installer first-run UX and self-service docs
...
- [ ] Update `H03-add-curl-installer-first-run-ux-and-self-service-result.md` or run `ds task checkpoint`.
