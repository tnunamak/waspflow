# Task 20260722-190800-complete-federation-linux-package-self-service-f H02 Plan

## Goal
prove fresh Ubuntu install daemon and UI smoke
...
- [ ] Update `H02-prove-fresh-ubuntu-install-daemon-and-ui-smoke-result.md` or run `ds task checkpoint`.
