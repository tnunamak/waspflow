# Task 20260722-154338-federation-wave-g-eliminate-web-ui-render-churn E03 Plan

## Goal
Run full verification, real-flow cancel, UI screenshot checks, and write Wave G report
...
- [ ] Update `E03-run-full-verification-real-flow-cancel-ui-screen-result.md` or run `ds task checkpoint`.
