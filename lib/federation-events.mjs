...
export const EVENT_TYPES = {
  ...
  sandbox_preflight: {
    description: 'doctor or contribute: Docker Sandboxes install preflight. `status: setup_required` means contribution did not claim or run a task.',
    requiredFields: ['status', 'backend_id', 'checks'],
  },
  no_task_available: {
  ...
  approved: {
    description: 'approve: the coordinator owner appended a member public key to the local, hot-reloaded roster file.',
    requiredFields: ['status', 'key_id', 'roster_file'],
  },
  not_joined: {
