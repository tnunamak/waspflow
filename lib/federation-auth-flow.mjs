...
import { sanitizedEnv } from './federation-docker-backend.mjs';
 ...
 *
 * @param {import('./federation-harness-spec.mjs').HarnessSpec} harnessSpec
 * @param {{sandboxId: string, sbxBin?: string, env?: NodeJS.ProcessEnv, urlTimeoutMs?: number, completionTimeoutMs?: number, pollIntervalMs?: number}} opts
...
function sandboxEnv(baseEnv) {
  ...
  env.HOME = baseEnv.WASPFLOW_FEDERATION_SBX_HOME || baseEnv.HOME;
  return env;
}
