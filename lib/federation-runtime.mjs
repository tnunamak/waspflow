 ...
 *   image: string,                      // approved workload identifier (not a path)
...
export function validateJobSpec(spec) {
  ...
  const allowed = ['job_id', 'image', 'entrypoint', 'resources', 'inputs', 'output_manifest', 'egress_policy_id', 'capability_token'];
...
export class SandboxBackend {
  ...
  async start(_handle) { throw notImplemented('start'); }
