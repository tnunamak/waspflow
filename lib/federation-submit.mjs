...
export function buildTaskPayload({ collective, displayId, authorKeyId, source, prompt, gitSource, githubAccessRequired = false, network = 'disabled', createdAt = new Date(), expiresInSeconds = 3600 }) {
  ...
  const payload = {
    ...
    ...(githubAccessRequired || gitSource?.authenticationRequired ? { github_access_required: true } : {}),
