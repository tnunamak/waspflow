...
function task(payload) {
  keys(payload, ['schema', 'collective', 'display_id', 'author_key', 'created_at', 'expires_at', 'source', 'git_source', 'prompt', 'network', 'oracle_ref', 'result_verdict', 'settlement'], 'task payload');
